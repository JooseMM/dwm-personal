...
static const char *fonts[]          = { "Symbols Nerd Font:size=15", "InputSansCondensed Nerd Font:size=14" };
static const char dmenufont[]       = "InputSansCondensed Nerd Font:size=20";
